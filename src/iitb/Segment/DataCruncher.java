...
public class DataCruncher {
	...
	/**
	 * Returns an array of non delimiter tokens
	 * Also ignores impDelimit tokens
	 */
	 ...
	 * Each line is parsed into two tokens - the segment and the label
	 * (Should use String.split(delimiter,2) here)
	 * Populates an integer array t[] and a string array, cArray[][]
	 * t[] <- line labes
	 * cArray[] <- array of tokens
	 */
	...
	/**
	 * Responsible for reading, and preparing incoming labeled segment data.
	 * Input format can be fixed row or variable row
	 * For variable row data:
	 *   each line is expected:  data|label
	 *   an empty line represents the end of a segment 
	 */
